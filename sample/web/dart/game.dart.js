...
["client.action_dropper", "package:StupidBirdExpress/client/action_dropper.dart", , A, {
  "^": "",
  ActionDropper: {
    "^": "Object;allowDragging,parent,actionDraggers,_actionsCount,_lastPos,_isOnDrag,_dragged,_inserted,_ParentLeft,_ParentRight,_ParentTop,_ParentBottom,_ChildHeight",
    ...
    _initValues$0: function() {
      ...
      if (typeof t2 !== "number")
        return t2.$mul();
      t2 = C.JSNumber_methods.toInt$0(Math.ceil(t1 * 0.05 + t2 * 0.9 * 0.19666666666666666)) - 10;
      this._ParentLeft = t2;
      t1 = window.innerWidth;
      if (typeof t1 !== "number")
        return t1.$mul();
      this._ParentRight = t2 + C.JSNumber_methods.toInt$0(Math.floor(t1 * 0.9 / 6 - 8)) + 20;
      t1 = window.innerHeight;
      if (typeof t1 !== "number")
        return t1.$mul();
      t1 = C.JSNumber_methods.toInt$0(Math.ceil(t1 * 0.03)) + 160;
      this._ParentTop = t1;
      this._ParentBottom = t1 + 580;
    },
    ...
    _isInDropbox$2: function(x, y) {
      var t1 = this._ParentLeft;
      if (typeof x !== "number")
        return x.$ge();
      if (typeof t1 !== "number")
        return H.iae(t1);
      if (x >= t1) {
        t1 = this._ParentRight;
        if (typeof t1 !== "number")
          return H.iae(t1);
        if (x <= t1) {
          t1 = this._ParentTop;
    ...
    _startDeleteActionListener$1: function(newElement) {
      ...
      listener = H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new A.ActionDropper__startDeleteActionListener_closure(t1, this, newElement)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)]);
  ...
  ActionDropper_getActionValues_closure: {
    ...
    call$1: function(child) {
      ...
      if (t1.get$classes(child).readClasses$0().contains$1(0, "b-turn")) {
        ...
        degree = H.Primitives_parseInt(C.JSString_methods.substring$2(t1, 0, J.getInterceptor$asx(t1).get$length(t1) - 1), null, null);
  ...
  ActionDropper__startDragListener_startMouseDownListener_closure: {
    "^": "Closure:9;box_0,this_2,elem_3,isSample_4",
    call$1: function(evt) {
      var t1, t2, t3, t4, t5;
      t1 = this.this_2;
      if (t1.allowDragging === true) {
        ...
        if (typeof t3 !== "number")
          return H.iae(t3);
        t4.left_2 = t2 - t3;
        t3 = H.setRuntimeTypeInfo(new P.Point(evt.pageX, evt.pageY), [null]).y;
        t2 = t4.offset_y_1;
        if (typeof t3 !== "number")
          return t3.$sub();
        if (typeof t2 !== "number")
        ...
        t1._dragged = t3.clone$1(t2, true);
        t1._inserted = t3.clone$1(t2, true);
        t5 = J.get$style$x(t1._dragged);
        J.getInterceptor$x(t5).set$position(t5, "absolute");
        C.CssStyleDeclaration_methods.set$zIndex(t5, C.JSInt_methods.toString$0(1000));
  ...
  ActionDropper__startDragListener_closure: {
    "^": "Closure:9;box_0,this_5,startMouseDownListener_6",
    call$1: function(evt) {
        ...
        if (t1._isInDropbox$2(J.get$x$x(t2.get$page(evt)), J.get$y$x(t2.get$page(evt)))) {
          ...
          if (t3 >= 1)
            if (t1._getValidPos$1(J.get$y$x(t2.get$page(evt))) === 0) {
              ...
              for (t3 = t1._ChildHeight, i = 0; i < W._FrozenElementList$_wrap(t1.parent.querySelectorAll(".b-action"), null)._nodeList.length; i = i0) {
                t4 = J.get$y$x(t2.get$page(evt));
                t5 = t1._ParentTop;
                if (typeof t4 !== "number")
                  return t4.$sub();
                if (typeof t5 !== "number")
                  return H.iae(t5);
                tempPos = C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0((t4 - t5 - 10) / t3));
                t4 = t1._actionsCount;
                if (typeof t4 !== "number")
                  return H.iae(t4);
                if (tempPos <= t4)
                ...
                i0 = i + 1;
                if (t4 === i0) {
                  t4 = W._FrozenElementList$_wrap(t1.parent.querySelectorAll(".b-action"), null)._nodeList;
                  if (i >= t4.length)
                    return H.ioore(t4, i);
                  J.set$borderBottom$x(J.get$style$x(t4[i]), "2px solid #cc0000");
                }
              }
        }
      }
  ...
  ActionDropper__startDeleteActionListener_closure: {
    "^": "Closure:9;box_0,this_1,newElement_2",
    call$1: function(_) {
      var t1, t2;
      J.remove$0$ax(this.newElement_2);
...
["client.game", "game.dart", , U, {
  ...
  main: [function() {
    ...
    t1 = t1[t2];
    t2 = t2 === 1;
    t4 = new X.LevelMap(t1, null, null, null, null, null, null, t2, null, null, null, null, null, null, null, null, t3);
    t4.LevelMap$3(t3, t1, t2);
    $.map = t4;
    $.mGenerator = new U.MotionGenerator(null);
    img = document.querySelector(".map-image");
    t4 = $.get$MapBackground();
    t2 = $.rand;
    if (t2 >>> 0 !== t2 || t2 >= 3)
      return H.ioore(t4, t2);
    J.set$src$x(img, t4[t2]);
    dropper = new A.ActionDropper(null, null, null, null, null, null, null, null, null, null, null, null, 40);
    dropper._initValues$0();
    dropper._startDragListener$0();
...
["client.level_map", "package:StupidBirdExpress/client/level_map.dart", , X, {
  "^": "",
  LevelMap: {
    "^": "Object;map,mapBlock,mainActorImgs,mainActor,mainActorLeft,mainActorTop,degree,isMap2,_boat,_flower,_level_map$_message,_completeBtn,_boatLeft,_boatTop,_isOnBoat,_isComplete,_actorInfo",
    resetPos$0: function() {
      var t1, t2;
      t1 = this._actorInfo;
      ...
      for (t1 = this.map, i = 0; i < 12; ++i)
        for (j = 0; j < 14; ++j) {
          ...
          if (J.$le$n(J.$index$asx(t1[i], j), 8)) {
            ...
            if (i >= t1.length)
              return H.ioore(t1, i);
            if (J.$eq(J.$index$asx(t1[i], j), 2)) {
              img = W.ImageElement_ImageElement(null, null, null);
              J.set$src$x(img, t3[6]);
              t2 = img.style;
              J.getInterceptor$x(t2).set$width(t2, "45px");
              C.CssStyleDeclaration_methods.set$height(t2, "45px");
    ...
    LevelMap$3: function(_actorInfo, map, isMap2) {
  ...
  LevelMap_startMove_closure: {
    "^": "Closure:9;box_0,this_1,pos_2,imgs_3,highlight_4",
    call$1: function(_) {
...
Isolate.$lazy($, "BlockImgs", "BlockImgs", "get$BlockImgs", function() {
  return ["../../source/arbor1.png", "../../source/arbor2.png", "../../source/arbor3.png", "../../source/arbor4.png", "../../source/bush.png", "../../source/straw.png", "../../source/logo_fat.png", "../../source/tree1.png", "../../source/tree2.png", "../../source/tree3.png", "../../source/tree4.png", "../../source/flower.png"];
});
